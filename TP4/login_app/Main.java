...
public class Main {
    ...
    private static void showLoginMenu() {
        ...
        while (username.isEmpty()) {
            System.out.println("Tolong Ketik Username!");
            System.out.print("> ");
            username = sc.next();
        }
    ...
    private static void showRegisterMenu() {
        ...
        while (username.isEmpty() || usernameTerpakai(username)){
            if (username.isEmpty()){
                System.out.println("Error: Masukkan Username");

            }
            if (usernameTerpakai(username)){
                System.out.println("Error : Username Terpakai! ");
        ...
        while (hobby.isEmpty()){
            System.out.println("Error: Tolong Ketik Hpbby");
            System.out.print("> ");
            hobby = sc.nextLine();
        }
